...
public class IOConstants {
    ...
    public static final char SELL_INPUT = 's';

    // EQUIP UNEQUIP PROMPTS
    public static final char EQUIP_INPUT = 'e';
    public static final char UNEQUIP_INPUT = 'u';

    // EXPLORE INVENTORY
    public static final char EXPLORE_INPUT = 'v';
    public static final char CHANGE_WEAPON_INPUT = 'w';
    public static final char CHANGE_ARMOR_INPUT = 'a';
    public static final char CONSUME_POTION_INPUT = 'p';
